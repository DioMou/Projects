...
DB_HOST = "database-mp6-instance-1.ct2conjworys.us-east-1.rds.amazonaws.com"
DB_USER = "admin"
DB_PASS = "Jowaq8421?"
DB_NAME = "mp6"
DB_TABLE = "heroTable"
REDIS_URL = "redis://mp6elc.erqbye.ng.0001.use1.cache.amazonaws.com:6379"
    ...
    for sql in sqls:
        ...
        if use_cache:
            ...
            if not exist:#if not Cache.get(idx)
                ...
                #insert_cmd = f"INSERT INTO heroTable (`id`, `hero`, `power`, `name`, `xp`, `color`) VALUES ('{str(idx)}', '{hero}', '{power}', '{name}', '{xp}', '{color}')"
                #print(insert_cmd)
                #record=Database.query(insert_cmd)
